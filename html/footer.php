        ...
        <div class="row">
                ...
                <div class="footer__contact">
                    ...
                    <ul>
                        <li>
                            ...
                            <span>Q. Bắc Từ Liêm, Hà Nội</span>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <span>mtp.travel.company@gmail.com</span>
                        </li>
                    </ul>
                    <h4 style="padding: 15px 0">Đăng ký để được nhận thông tin khuyến mãi một cách nhanh chóng.</h4>
                    <div class="email-bl">
            ...
            <div class="col l-3">
                <div class="footer__user">
                    ...
                    <ul>
                        <li>
                            <a href="#">Điều kiện & điều khoản</a>
                        </li>
                        <li>
                            <a href="#">Quyền riêng tư</a>
                        </li>
                        <li>
                            <a href="#">Chính sách bảo mật và thông tin</a>
                        </li>
                        <li>
                            <a href="#">Ý kiến khách hàng</a>
                        </li>
                        <li>
                            <a href="#">Phương thức thanh toán</a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="col l-3">
                <div class="footer__popularTour">
                    <div class="title">
                        <h3>Tour Phổ Biến</h3>
                    </div>
                    <div class="images grid">
                        <div class="row">
                            <div class="col l-4">
                                <a href="#" class="image-ctn">
                                    <img src="https://images.unsplash.com/photo-1477414348463-c0eb7f1359b6?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" 
                                    alt="">
                                </a>
                            </div>
                            <div class="col l-4">
                                <a href="#" class="image-ctn">
                                    <img src="https://images.unsplash.com/photo-1550686041-366ad85a1355?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80https://images.unsplash.com/photo-1550686041-366ad85a1355?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80" 
                                alt="">
                                </a>
                            </div>
                            <div class="col l-4">
                                <a href="#" class="image-ctn">
                                    <img src="https://images.unsplash.com/photo-1524856949007-80db29955b17?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" 
                                    alt="">
                                </a>
                            </div>
                            <div class="col l-4">
                            ...
                            <div class="col l-4">
                                <a href="#" class="image-ctn">
                                    <img src="https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1274&q=80" 
                                    alt="">
                                </a>
                            </div>
                            <div class="col l-4">
                                <a href="#" class="image-ctn">
                                    <img src="https://images.unsplash.com/photo-1472214103451-9374bd1c798e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" 
                                    alt="">
                                </a>
                            </div>
                        </div>
